...
const exerciseSchema = mongoose.Schema({
	name: { type: String, required: true, default: 'Exercise Name'},
	reps: { type: Number, required: true, default: 0 }, 
	weight: { type: Number, required: true, default: 0, min: 1, max: 300},
    unit: { type: String, required: true, default: 'lbs', },
    date: { type: Date, required: true, min: '2021/11/18', default: new Date()}
});
